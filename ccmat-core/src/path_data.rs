...
#[cfg(test)]
mod tests {
    use crate::{lattice_angstrom, sites_frac_coord, CrystalBuilder};
    ...
    fn eval_hR1_noinv() {
        ...
        let sites = sites_frac_coord![
            // (0.0000000000000000, 0.0000000000000000, 0.2797794000000000), element!(Cu);
            // (0.6666666666666666, 0.3333333333333333, 0.6131127333333333), element!(Cu);
            // (0.3333333333333333, 0.6666666666666666, 0.9464460666666666), element!(Cu);
            // (0.0000000000000000, 0.0000000000000000, 0.0252206000000002), element!(I);
            // (0.6666666666666666, 0.3333333333333333, 0.3585539333333334), element!(I);
            // (0.3333333333333333, 0.6666666666666666, 0.6918872666666668), element!(I);
            (0.0000000000000000, 0.0000000000000000, 0.2797794000000000), 28;
            (0.6666666666666666, 0.3333333333333333, 0.6131127333333333), 28;
            (0.3333333333333333, 0.6666666666666666, 0.9464460666666666), 28;
            (0.0000000000000000, 0.0000000000000000, 0.0252206000000002), 40;
            (0.6666666666666666, 0.3333333333333333, 0.3585539333333334), 40;
            (0.3333333333333333, 0.6666666666666666, 0.6918872666666668), 40;
        ];
